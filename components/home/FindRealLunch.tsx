...
export default function FindRealLunch() {
  ...
  return (
    <section className="bg-[#F5F3FF] py-10 px-[5px] md:px-14">
      ...
      >
        <div className="mx-auto max-w-7xl pt-10 pb-0 md:py-10 px-5 md:px-12">
          ...
          {/* Table — desktop only (mobile image rendered outside this wrapper) */}
        ...
        {/* Mobile table image — full width of orange card */}
        <img
